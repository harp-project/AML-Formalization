...
Section with_signature.
  ...
  *)
  ...
  Proof.
    ...
    mlIntro.
    mlApply "2".
    pose proof (Htmp := BasicProofSystemLemmas.Ex_quan Γ ((!ϕ)^{{evar: x ↦ 0}}) x).
  ...
  *)
  ...
  Proof.
    ...
    apply BasicProofSystemLemmas.Ex_gen. apply pile_refl.
  ...
  Proof.
    ...
    epose proof (BasicProofSystemLemmas.Ex_gen Γ (! g^{evar: 0 ↦ x}) ⊥ x i _ _).
