...
(*     intros. unfold kore_well_founded, kore_well_founded_alt.
  ...
  Proof.
    ...
    mlApplyMeta deMorgan_nand_1 in "H2".
    mlDestructOr "H2".
    * mlApplyMeta not_not_elim in "0".
      mlConj "0" "H1" as "H2".
      mlApply "H" in "H2".
      mlDestructAnd "H2".
      mlAssumption.
  ...
  Proof.
    ...
    * mlSplitAnd; try mlAssumption.
      mlDestructAnd "H1". mlApply "0".
      mlIntro. mlDestructAnd "2". mlApply "3".
      mlAssumption.
    * mlApply "H1" in "H0_2".
      mlDestructBot "H0_2".
    * mlSplitAnd; try mlAssumption.
      mlDestructAnd "H1". mlApply "1".
      mlIntro. mlDestructAnd "2". mlApply "3".
      mlAssumption.
    * mlApply "H1" in "H0_2".
      mlDestructBot "H0_2".
  ...
  Proof.
    ...
    * mlIntro.
      unfold kore_not.
      mlApplyMeta deMorgan_nand_1 in "0".
      mlDestructOr "0".
      - mlApplyMeta not_not_elim in "1".
        mlConj "1" "H2" as "H3".
        fold (φ ∷ s1).
        mlApply "H0" in "H3".
        mlDestructAnd "H3".
