...
Section FOL_helpers.
  ...
  Proof.
    intros H. unfold reorder_meta. solve_indif. assumption.
  Qed.
  ...
  Canonical Structure modus_ponens_indifferent_S (P : proofbpred) {Pip : IndifProp P}
          (Γ : Theory) (A B : Pattern)
          (wfA : well_formed A)
          (wfB : well_formed B)
    := ProofProperty0 P (@modus_ponens Γ A B wfA wfB) (@modus_ponens_indifferent P Pip Γ A B wfA wfB).
  ...
  Program Canonical Structure not_not_intro_indifferent_S (P : proofbpred) {Pip : IndifProp P}
          (Γ : Theory) (A : Pattern)
          (wfA : well_formed A)
    := ProofProperty0 P (@not_not_intro Γ A wfA) _.
  Next Obligation.
    intros. unfold not_not_intro. unfold patt_not. solve_indif.
  Qed.
  ...
  Program Canonical Structure deduction_indifferent_S (P : proofbpred) {Pip : IndifProp P}
          (Γ : Theory) (A B : Pattern)
          (wfA : well_formed A)
          (wfB : well_formed B)
    := ProofProperty2 P (@deduction Γ A B wfA wfB) _.
  Next Obligation.
    intros. unfold deduction. solve_indif. assumption.
  Qed.
  ...
  Next Obligation. intros. unfold conj_intro. solve_indif. Qed.
  ...
  Proof. intros H1 H2. unfold conj_intro_meta. solve_indif; assumption. Qed.
  ...
  Proof. intros. unfold syllogism_4_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold modus_ponens'. solve_indif. Qed.
  ...
  Proof. unfold disj_right_intro. unfold patt_or. solve_indif. Qed.
  ...
  Proof. unfold disj_left_intro. unfold patt_or. solve_indif. Qed.
  ...
  Next Obligation. intros. unfold disj_right_intro_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold disj_left_intro_meta. solve_indif; assumption. Qed.
  ...
  Proof. unfold not_not_elim. unfold patt_not. solve_indif. Qed.
  ...
  Next Obligation. intros. unfold not_not_elim_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold double_neg_elim. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold double_neg_elim_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold P4_rev_meta. solve_indif; try assumption. Qed.
  ...
  Program Canonical Structure P4_rev_meta'_indifferent_S
        P {Pip : IndifProp P} Γ a b (wfa : well_formed a = true) (wfb : well_formed b = true)
    := ProofProperty1 P (@P4_rev_meta' Γ a b wfa wfb) _.
  Next Obligation. intros. unfold P4_rev_meta'. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold P4m_neg. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold not_not_impl_intro_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold not_not_impl_intro. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold contraposition. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold or_comm_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold A_implies_not_not_A_alt. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold P5i. solve_indif; assumption. Qed.
...
Defined. *)
  ...
  Next Obligation. intros. unfold A_implies_not_not_A_alt_Γ. solve_indif. assumption. Qed.
  ...
  Next Obligation. intros. unfold exclusion. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold modus_tollens. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold A_impl_not_not_B. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_weaken_conclusion. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_weaken_conclusion_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_weaken_conclusion_iter_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_weaken_conclusion_iter_meta_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_weaken_conclusion_meta_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_strenghten_premise. solve_indif; assumption. Qed.
  ...
  Next Obligation.
    intros.
    induction l₁.
    - unfold prf_strenghten_premise_iter. simpl. solve_indif.
    - unfold prf_strenghten_premise_iter. simpl.
      case_match. simpl.
  ...
  Next Obligation. intros. unfold prf_strenghten_premise_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_strenghten_premise_meta_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_strenghten_premise_iter_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_strenghten_premise_iter_meta_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold rewrite_under_implication. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold prf_reorder_iter_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold A_impl_not_not_B_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold pf_conj_elim_l_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold pf_conj_elim_r_meta. solve_indif; assumption. Qed.
  ...
  Next Obligation. intros. unfold P4m_meta. solve_indif; assumption. Qed.
...
Structure tacticProperty1 {Σ : Signature} (P : proofbpred) (Γ : Theory)
  ...
  := TacticProperty1 {
      ...
      forall (pf : @mkMyGoal Σ Γ l₁ g₁),
        (forall wf3 wf4, liftP P Γ l₁ g₁ (pf wf3 wf4) = false) ->
        (forall wf1 wf2, liftP P Γ l₂ g₂ ((tp1_tactic pf) wf1 wf2) = false)
    }.
...
Structure tacticProperty2 {Σ : Signature} (P : proofbpred) (Γ : Theory)
  ...
  := TacticProperty2 {
      ...
      forall (pf₁ : @mkMyGoal Σ Γ l₁ g₁) (pf₂ : @mkMyGoal Σ Γ l₂ g₂),
        (forall wf3 wf4, liftP P Γ l₁ g₁ (pf₁ wf3 wf4) = false) ->
        (forall wf5 wf6, liftP P Γ l₂ g₂ (pf₂ wf5 wf6) = false) ->
        (forall wf1 wf2, liftP P Γ l₃ g₃ ((tp2_tactic pf₁ pf₂) wf1 wf2) = false)
    }.
...
Structure tacticProperty1_1 {Σ : Signature} (P : proofbpred) (Γ : Theory)
  ...
  := TacticProperty1_1 {
      ...
      forall (pf₁ : Γ ⊢ p₁) (pf₂ : @mkMyGoal Σ Γ l₂ g₂),
        (P Γ p₁ pf₁ = false) ->
        (forall wf5 wf6, liftP P Γ l₂ g₂ (pf₂ wf5 wf6) = false) ->
        (forall wf1 wf2, liftP P Γ l₃ g₃ ((tp1_1_tactic pf₁ pf₂) wf1 wf2) = false)
    }.
...
Program Canonical Structure MyGoal_intro_indifferent_S 
          ...
          Γ l x g
  := TacticProperty1 P (@MyGoal_intro Σ Γ l x g) _.
...
Lemma MyGoal_revert {Σ : Signature} (Γ : Theory) (l : list Pattern) (x g : Pattern):
  @mkMyGoal Σ Γ l (x ---> g) ->
  @mkMyGoal Σ Γ (l ++ [x]) g.
Proof.
  intros H.
...
Program Canonical Structure MyGoal_revert_indifferent_S 
          {Σ : Signature} (P : proofbpred) {Pic : IndifCast P}
          Γ l x g
  := TacticProperty1 P (@MyGoal_revert Σ Γ l x g) _.
Next Obligation. unfold MyGoal_revert. intros. unfold liftP. solve_indif. apply H. Qed.
...
Next Obligation.
  ...
  - simpl. case_match. apply liftP_impl_P. solve_indif; intros.
    + eapply (@tp1_1_tactic_property Σ P Γ _ _ (_) _ _ (@MyGoal_applyMeta_indifferent_S Σ P _ _ Γ _ _ _ )).
      { solve_indif. }
      solve_indif.
      intros.
      eapply (@tp1_1_tactic_property Σ P Γ _ _ (_) _ _ (@MyGoal_applyMeta_indifferent_S Σ P _ _ Γ _ _ _ )).
...
Next Obligation. unfold prf_local_goals_equiv_impl_full_equiv_meta. solve_indif; assumption. Qed.
...
Next Obligation. unfold prf_local_goals_equiv_impl_full_equiv_meta_proj1.  solve_indif; assumption. Qed.
...
Next Obligation. unfold prf_local_goals_equiv_impl_full_equiv_meta_proj2. solve_indif; assumption. Qed.
...
Next Obligation. unfold pf_iff_equiv_sym_nowf. solve_indif; assumption. Qed.
...
Next Obligation. unfold top_holds. solve_indif; assumption. Qed.
...
Next Obligation. intros. unfold prf_and_assoc. apply liftP_impl_P. solve_indif. Qed.
...
Next Obligation. intros. unfold prf_or_assoc. apply liftP_impl_P. solve_indif. Qed.
...
Next Obligation.
  intros. unfold prf_not_and_is_or_not. apply liftP_impl_P. solve_indif; intros.
  - apply (@tp1_1_tactic_property Σ P Γ _ _ _ _ _ (@MyGoal_applyMetaIn_indifferent_S Σ P _ _ Γ [] [] _ _ _)).
    { solve_indif. }
    intros. solve_indif.
...
Next Obligation.
  intros. unfold Top_and_phi. apply liftP_impl_P. solve_indif. intros. simpl. solve_indif.
...
Next Obligation.
  intros. unfold phi_and_Top. apply liftP_impl_P. solve_indif. intros. simpl. solve_indif.
  intros. unfold liftP. solve_indif.
Qed.
...
Next Obligation.
  unfold Bot_and_phi.
  intros. apply liftP_impl_P. solve_indif. unfold liftP. solve_indif.
Qed.
