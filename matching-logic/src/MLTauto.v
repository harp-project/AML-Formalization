...
Section ml_tauto.
  ...
  Proof.
    Check inl (match_and ((patt_bound_evar 0) and (patt_bound_evar 1))).
    simp negate.
    Search negate.
    eapply negate_clause_1_equation_1. Unshelve. all: auto.
  Qed.
  ...
  Example simple1_5 (x y : Pattern): negate (patt_and x y) = (patt_or (negate x) (negate y)).
  Proof.
    simp negate. rewrite (negate_clause_1_equation_1 (x and y) x y).
    Search "negate_clause_1_clause_2_clause_2_clause_2_equation_2".
    simp negate. auto.
  Qed.
